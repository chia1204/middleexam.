...
let isOrangeMode = false; // 用於控制橘色系模式
...
function draw() {
  // 根據模式設置背景顏色
  if (isBlueMode) {
    background("rgba(201, 224, 247, 0.5)"); // 藍色系背景，透明度 50%
  } else if (isPurpleMode) {
    background("rgba(218, 191, 255, 0.5)"); // 紫色系背景，透明度 50%
  } else if (isWhiteMode) {
    background("rgba(255, 255, 255, 0.5)"); // 白色背景，透明度 50%
  } else if (isYellowMode) {
    background("rgba(255, 250, 205, 0.5)"); // 黃色背景，透明度 50%
  } else if (isPinkMode) {
    background("rgba(236, 202, 207, 0.5)"); // 粉色背景，透明度 50%
  } else if (isGreenMode) {
    background("rgba(123, 159, 119, 0.5)"); // 低飽和度綠色背景，透明度 50%
  } else if (isOrangeMode) {
    background("rgba(232, 209, 167, 0.5)"); // 橘色背景，透明度 50%
  } else {
    background("rgba(250, 237, 205, 0.5)"); // 預設背景，透明度 50%
  }
  ...
  for (let t of triangles) {
    ...
    if (isBlueMode) {
      // 藍色系三角形
      adjustedColor = [random(100, 150), random(150, 200), random(200, 255), 150]; // 提高透明度
    } else if (isPurpleMode) {
      // 紫色系三角形
      adjustedColor = [random(200, 220), random(150, 180), random(200, 255), 150]; // 提高透明度
    } else if (isPinkMode) {
      // 粉色系三角形
      adjustedColor = [random(255, 182), random(150, 100), random(200, 220), 150]; // 提高透明度
    } else if (isGreenMode) {
      // 低飽和度綠色系三角形（不透明）
      adjustedColor = [random(150, 180), random(200, 230), random(150, 180), 255]; // 不透明
    } else if (isOrangeMode) {
      // 橘色系三角形
      adjustedColor = [random(255, 200), random(150, 100), random(50, 0), 255]; // 不透明
    } else {
      // 原始顏色
